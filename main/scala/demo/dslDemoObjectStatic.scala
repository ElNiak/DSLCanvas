...
import DSLStatic.{Canvasy, CanvasyElementModifier, Circle, Color, Radius, Rectangle, Shape, StrokeColor, Width}
import DSLStatic.ColorRGB.ColorRGBUtils

object dslDemoObjectStatic {
  ...
  def dslDemo(canvas: html.Canvas): Unit = {
